...
namespace R54_M8_Class_09_Work_01.Migrations
{
    /// <inheritdoc />
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobSeekerJobPosts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobSeekerJobPosts_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobSeekerJobPosts_UserId",
                table: "JobSeekerJobPosts",
                column: "UserId");
        }
